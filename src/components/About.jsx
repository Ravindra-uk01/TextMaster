  ...
  return (
    <div className="container" style={{ color }}>
      ...
      <p>
        ...
        for text drafting, and saving, but <i>TextMaster</i> offers much more
        than simple text drafting and formatting. TextMaster can convert your
        ...
        reading time as well. The best part of <i>TextMaster</i> is that it is an
